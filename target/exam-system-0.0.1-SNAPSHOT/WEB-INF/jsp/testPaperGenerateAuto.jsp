			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<div id="set_qt_div">
							<table class="table table-bordered table-hover">
								...
								<c:if test="${questionTypes!=null}">
									<c:forEach items="${questionTypes}" var="qt">
										<tr>
											<td id="${qt.tId}_title">${qt.tTitle}</td>
											<td>
												<select style="width:80px" id="set_qt_${qt.tId}_num" name="changes_num"></select>
											</td>
											<td>
						...
						<!-- 弹出生成的试卷信息div -->
						<div class="modal fade" id="paper_div" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
									...
									<div class="modal-body">
										<table class="table table-striped table-bordered" id="paper_table">
