					...
					<ul class="sub-menu">
						...
						<li class="active">
							...
							<ul class="sub-menu">
								...
								<li  class="active"><a href="../../knowledgePoints/all">知识点维护</a></li>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="../../knowledgePoints/all">知识点维护</a>
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href="#">知识点修改</a>
				...
				<div class="row-fluid">
					...
					<!-- 内容主体开始 -->
					<div class="span12">
						<c:if test="${KPModifyError!=null}">
		<c:out value="${KPModifyError}"></c:out>
	</c:if>

	<sf:form commandName="knowledgePoints">

		<sf:hidden path="subjectId" />
		<sf:hidden path="kAddtime" />

		<sf:select path="subjectTitle">
			<sf:options items="${sTitles}" />
		</sf:select>
		</br>

		<sf:label path="kNum" cssClass="error">知识点序号:</sf:label>
		<sf:input path="kNum" cssClass="error"></sf:input>

		<sf:label path="kSubNum" cssClass="error">.</sf:label>
		<sf:input path="kSubNum" cssClass="error"></sf:input>
		<sf:errors path="kNum" cssClass="error"></sf:errors>
		<sf:errors path="kSubNum" cssClass="error"></sf:errors>
		</br>

		<sf:label path="kTitle">知识点标题:</sf:label>
		<sf:input path="kTitle" cssClass="error"></sf:input>
		<sf:errors path="kTitle" cssClass="error"></sf:errors>
		</br>
