...
<body class="page-header-fixed">
					...
					<ul class="sub-menu">
						...
						<li class="active">
							...
							<ul class="sub-menu">
								...
								<li class="active"><a href="../systemConfig/all">系统信息查看</a></li>
					...
					<div class="span12">
						<c:if test="${systemConfigs!=null}">
							<table class="table table-striped table-bordered" id="table">
								<th colspan="3">基本信息设置</th>
								<tr>
									<th>键</th>
									<th>值</th>
									<th>操作</th>
								</tr>
								<c:forEach items="${systemConfigs}" var="sc">
									<tr>
										<td><c:out value="${sc.key}"/></td>
										<td><c:out value="${sc.value}" /></td>
										<td><button class="btn btn-default" id="button_modify" modifyId="${sc.id}" data-toggle="modal" data-target="#modifyModal">修改</button> <a class="btn btn-default" href="delete/${sc.id}">删除</a></td>
									</tr>
								</c:forEach>
							</table>
						</c:if>
						...
						<!-- 增加 -->
						<div class="pull-right"><a href="add" data-toggle="tooltip" data-placement="top" title="添加系统信息"><img src="../public/media/image/add.png" /></a></div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<div class="form-group"><label>ID:</label><input type="text" name="id" id="id" value="" class="form-control"></div>
										<div class="form-group"><label>键：</label><input type="text" name="key" id="key" value="" class="form-control"></div>
										<div class="form-group"><label>值：</label><input type="text" name="value" id="value" value="" class="form-control"></div>
	...
	<script src="../public/js/systemConigs.js"></script> 
	<script>
