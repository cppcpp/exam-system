...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
		...
		<c:if test="${subjectAddError!=null}">
		<c:out value="${subjectAddError}"></c:out>
	</c:if>
	<sf:form commandName="subject" method="post">
		<sf:label cssErrorClass="error" path="sTitle">名称</sf:label>
		<sf:input path="sTitle" />
		<sf:errors cssClass="error" path="sTitle" /></br>

		<sf:label cssErrorClass="error" path="sDesc">描述</sf:label>
		<sf:input path="sDesc" />
		<sf:errors cssClass="error" path="sDesc" /></br>
