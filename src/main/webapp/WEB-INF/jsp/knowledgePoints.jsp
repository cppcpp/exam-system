...
<script type="text/javascript" src="../public/js/knowledgePoints.js"></script>
</head>
<body class="page-header-fixed">
	...
	<tr>
		...
		<c:if test="${knowledgePoints!=null}">
			...
			<tr>
				<td>${kp.kNum}.${kp.kSubNum}</td>
				<td>${kp.kTitle}</td>
				<td>${kp.subjectTitle}</td>
				<td><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${kp.kAddtime}"></fmt:formatDate></td>
				<td><a href="modify/${kp.kId}">修改</a>|<a href="delete/${kp.subjectId}/${kp.kId}">删除</a></td>
				</tr>
			</c:forEach>
		</c:if>
	<tr>
