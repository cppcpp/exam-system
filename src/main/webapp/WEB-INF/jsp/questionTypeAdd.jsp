					...
					<ul class="sub-menu">
						...
						<li   class="active">
							...
							<ul class="sub-menu">
								...
								<li  class="active"><a href="../questionType/add">题型录入</a></li>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 内容主体 -->
					<div class="span12">
						<sf:form commandName="questionType">
		<sf:label path="tTitle" cssClass="error">题型</sf:label>
		<sf:input path="tTitle" cssClass="error"></sf:input>
		<sf:errors path="tTitle" cssClass="error"></sf:errors>
		
		<sf:label path="tDesc" cssClass="error">题型描述</sf:label>
		<sf:input path="tDesc" cssClass="error"></sf:input>
		<sf:errors path="tDesc" cssClass="error"></sf:errors>
