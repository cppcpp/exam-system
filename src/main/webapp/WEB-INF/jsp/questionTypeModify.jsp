		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="../../questionType/all">题型维护</a>
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href="#">题型修改</a>
				...
				<div class="row-fluid">
					...
					<!-- 内容主体开始 -->
					<div class="span12">
						<c:if test="${questionTypeModifyError!=null}">
		<c:out value="${questionTypeModifyError}"/>
	</c:if>
	
	<sf:form commandName="questionType" method="post">
		<sf:label cssErrorClass="error" path="tTitle">名称</sf:label>
		<sf:input path="tTitle" />
		<sf:errors cssClass="error" path="tTitle" /></br>

		<sf:label cssErrorClass="error" path="tDesc">描述</sf:label>
		<sf:input path="tDesc" />
		<sf:errors cssClass="error" path="tDesc" /></br>
