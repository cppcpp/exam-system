...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
					...
					<ul class="sub-menu">
						...
						<li class="active">
							...
							<ul class="sub-menu">
								...
								<li class="active"><a href="../knowledgePoints/add">知识点录入</a></li>
		...
		<c:if test="${knowledgePointAddError!=null}">
		<c:out value="${knowledgePointAddError}"></c:out>
	</c:if>
	...
	<%-- <sf:errors path="subjectId" cssClass="error"></sf:errors></br> --%>
	...
	<sf:input path="kSubNum" cssClass="error"></sf:input></br>
	<%-- <sf:errors path="kNum" cssClass="error"></sf:errors>
	<sf:errors path="kSubNum" cssClass="error"></sf:errors></br> --%>
	
	<sf:label path="kTitle">知识点标题:</sf:label>
	<sf:input path="kTitle" cssClass="error"></sf:input>
	<%-- <sf:errors path="kTitle" cssClass="error"></sf:errors></br> --%>
