...
<body class="page-header-fixed">
						...
						<c:if test="${users!=null}">
							<c:forEach items="${users}" var="user">
								<tr>
									...
									<td><c:out value="${user.powerChinese}"/></td>
									<td><c:out value="${user.name}"/></td>
									<td><c:out value="${user.parentName}" /></td>
									<td><c:out value="${user.subjects}" /></td>
									<td><c:out value="${user.registTime}" /></td>
									<td><c:out value="${user.recentLoginTime}"/></td>
									<td><a class="btn btn-default" class="btn btn-default" href="../modify/${user.uId}">修改</a> <a class="btn btn-default" href="../delete/${user.uId}">删除</a></td>
								</tr>
							</c:forEach>
						</c:if>
						</table>
						<a href="${power}?pageNum=${page.firstPage}">首页</a>|<a href="${power}?pageNum=${page.prePage}">上一页</a>|<a href="${power}?pageNum=${page.nextPage}">下一页</a>|<a href="${power}?pageNum=${page.lastPage}">尾页</a></br>
	...
	<script>
		...
		$("#table tr").click(function(){
			var uId,username,password,name,power,parentId,registTime,recentLoginTime;
