				...
				<li class="active">
					...
					<ul class="sub-menu">
						...
						<li class="active">
							...
							<ul class="sub-menu">
								<li class="active"><a href="../news/add">公告信息添加</a></li>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<!-- 内容主体 -->
					<div class="span12">
						<sf:form commandName="news">
						<div class="form-group">
							<!-- 隐藏用户id   从session中取的值 -->
							<sf:input path="userId" value="${user.uId}" class="hidden"/>		
							<sf:label path="nContent">公告内容：</sf:label>
							<sf:textarea path="nContent" class="form-control" rows="6" />
							<sf:errors path="nContent" />
						</div>
