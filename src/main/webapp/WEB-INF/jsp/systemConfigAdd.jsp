	...
	<div class="page-container row-fluid">
				...
				<li class="active">
					...
					<ul class="sub-menu">
						...
						<li class="active">
							...
							<ul class="sub-menu">
								<li class="active"><a href="../systemConfig/add">系统信息添加</a></li>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<c:if test="${systemConfigAddError!=null }">
						<c:out value="${systemConfigAddError}"></c:out>
					</c:if>
				
					<!-- 内容主体 -->
					<div class="span12">
						<sf:form commandName="systemConfig">
							<div class="form-group">
								<sf:label path="key" cssErrorClass="error">键：</sf:label>
								<sf:input path="key" cssErrorClass="error" class="form-control"/>
								<sf:errors path="key" cssClass="error"/>
							</div>
							<div class="form-group">
								<sf:label path="value" cssErrorClass="error">值：</sf:label>
								<sf:input path="value" cssErrorClass="error" class="form-control"></sf:input>
