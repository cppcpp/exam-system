...
<body class="page-header-fixed">
	...
	<div class="page-container row-fluid">
		...
		<c:if test="${nullSubjects!=null}">
		<a href="add"><c:out value="${nullSubjects}"/></a>
	</c:if>
	<c:if test="${subjects!=null}">
		<table class="table table-striped table-bordered">
			<tr><th colspan="5">科目列表</th></tr>
			<tr>
				<td>名称</td>
				<td>描述</td>
				<td>添加时间</td>
			...
			<c:forEach items="${subjects}" var="subject">
				<tr>
					<td><c:out value="${subject.sTitle}"></c:out></td>
					<td><c:out value="${subject.sDesc}"></c:out></td>
					<td><fmt:formatDate value="${subject.sAddTime}" pattern="yyyy-MM-dd hh:mm:ss" /></td>
					<td><a href="modify/${subject.sId}">修改</a>|<a href="delete/${subject.sId}">删除</a></td>
				</tr>
		</c:forEach>
		</table>
		
		<!-- 增加 -->
		<div class="pull-right"><a href="add" data-toggle="tooltip" data-placement="top" title="添加科目"><img src="../public/media/image/add.png" /></a></div>
