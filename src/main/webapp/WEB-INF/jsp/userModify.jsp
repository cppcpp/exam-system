					...
					<ul class="sub-menu">
						<li class="active">
							...
							<ul class="sub-menu">
								...
								<li <c:if test="${power==1}">class="active"</c:if>><a href="../../user/all/1">录入人员管理</a></li>
								<li <c:if test="${power==2}">class="active"</c:if>><a href="../../user/all/2">任课教师管理</a></li>
								<li <c:if test="${power==3}">class="active"</c:if>><a href="../../user/all/3">超级用户管理</a></li>
							</ul>
						</li>
						<li>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						<!-- 内容主体部分 -->
						<sf:form commandName="modifyUser" id="form">
							<div class="form-group">
								<sf:label class="bold" path="username" cssErrorClass="error">用户名</sf:label>
							...
							<div class="form-group">
								...
								<sf:input type="password" class="from-control" path="password" id="password" disabled="true"/>
								<sf:errors path="password" cssClass="error"/>
							</div>
							
						<%-- 	<div class="form-group">
								<label class="bold">确认密码</label>
								<input type="password" name="comfirmPassword" class="from-control" id="confirmPassword"/>
							</div> --%>
							...
							<div class="form-group">
								...
								<c:if test="${powerResult!=null}">
									<c:forEach items="${powerResult}" var="power">
										<label class="radio inline">
											<c:if test="${power.exits==true}">
												<input type="radio" name="power" value="${power.power}" checked="checked"/><c:out value=" ${power.powerChinese}"/>
											</c:if>
											<c:if test="${power.exits==false}">
												<input type="radio" name="power" value="${power.power}" /><c:out value=" ${power.powerChinese}"/>
											</c:if>
										</label>
									</c:forEach>
								</c:if>
							...
							<div class="form-group">
								...
								<c:if test="${subjectsResult!=null}">
									<c:forEach items="${subjectsResult}" var="subject">
										<label class="checkbox inline">
											<c:if test="${subject.exits==true}">
												<input type="checkbox" name="subjects" value="${subject.sId}" checked="checked"><c:out value="${subject.sTitle }"/>
											</c:if>
											<c:if test="${subject.exits==false }">
